            ...
            return (
              <div key={ad.id} className="card p-4 flex items-center gap-4 hover:shadow-md transition-shadow group">
                ...
                <div className="flex-1 min-w-0">
                  <Link href={buildAdUrl(ad.serial_number)} className="font-bold text-ink hover:text-brand-500 transition-colors block truncate">
                    {ad.title}
                  </Link>
                ...
                <span className={`badge text-[10px] h-6 ${

    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-ink-tertiary font-medium">Loading your conversations...</p>
        </div>
      </div>
    );
  }
              ...
              {threads.map((thread) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-brand-50 text-brand-600
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 mb-0.5">
                        ...
                        <span className="text-[10px] text-ink-tertiary whitespace-nowrap">
                          {timeAgo(thread.lastTime)}
                        </span>
                      </div>
                      <p className={`text-xs truncate ${thread.unread ? 'text-ink font-medium' : 'text-ink-tertiary'}`}>
                  ...
                  <button
                    ...
                    className="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100
                               p-2 rounded-xl text-ink-tertiary hover:text-red-500 hover:bg-red-50 transition-all"
                  >
          ...
          <div className="md:col-span-2 card overflow-hidden flex flex-col bg-white border-none shadow-sm">
            {activeThread ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-ink-tertiary p-12 text-center">
                ...
                <p className="text-sm text-ink-secondary max-w-xs">Select one from the list to start chatting about the ad.</p>
              </div>
            )}
          </div>
        </div>

...
export async function getSession() {
  if (process.env.NODE_ENV === 'production' && !process.env.SESSION_SECRET) {
    ...
    console.error('The system is using a fallback secret. User sessions can be hijacked!');
    console.error('Please configure SESSION_SECRET in Vercel settings immediately. 🚨 🚨 🚨\n\n');
  }
